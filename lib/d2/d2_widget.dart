...
import 'd2_model.dart';
export 'd2_model.dart';
...
/// Navigation Tabs:
///
/// 🏠 Home – Leads to the dashboard screen.
///
/// 📄 Log – Opens the workout history/log screen.
///
/// 📊 Summary – Shows workout statistics and charts.
///
/// Design Style:
///
...
/// underline.
///
/// Font: Label text should be small (12–14pt), with the selected tab slightly
/// bolder or colored.
///
...
///
/// Tapping each tab should use FlutterFlow’s built-in navigation to switch
/// between pages smoothly.
///
/// 🔹 Design Style & Theme Guidelines
...
///
/// Headings should be bold and sized appropriately (e.g., 20–24pt for titles)
///
/// Subtext and labels should be around 14–16pt for readability
///
/// Spacing and Layout:
///
/// Use consistent padding (16–20px) and margin spacing
///
...
class D2Widget extends StatefulWidget {
  const D2Widget({super.key});

  static String routeName = 'd2';
  static String routePath = '/d2';

  @override
  State<D2Widget> createState() => _D2WidgetState();
}

class _D2WidgetState extends State<D2Widget> {
  late D2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => D2Model());
  }
